...
export default function CookieBanner() {
  ...
  return (
    <div
      ...
      className="cookie-banner fixed bottom-0 left-0 right-0 z-[100] border-t border-white/[0.08] bg-[#0D1118]/98 p-4 backdrop-blur-md sm:p-5 pb-[max(1rem,env(safe-area-inset-bottom))]"
    >
