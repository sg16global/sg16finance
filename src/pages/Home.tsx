...
export default function Home() {
  return (
    <div className="dashboard-canvas page-flow mx-auto max-w-[1440px] px-2 pt-1 pb-6 sm:px-3 lg:px-5 lg:pb-8">
      ...
      <div className="home-shield-stack grid items-start gap-3 sm:gap-4 lg:grid-cols-[minmax(0,280px)_1fr_minmax(0,280px)] xl:grid-cols-[minmax(0,300px)_1fr_minmax(0,300px)] xl:gap-4">
